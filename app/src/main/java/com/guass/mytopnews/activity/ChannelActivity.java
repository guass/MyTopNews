...
import com.guass.mytopnews.MyApp;
import com.guass.mytopnews.R;
import com.guass.mytopnews.adapter.DragAdapter;
import com.guass.mytopnews.adapter.OtherAdapter;
import com.guass.mytopnews.bean.ChannelItem;
import com.guass.mytopnews.bean.ChannelManage;
import com.guass.mytopnews.view.DragGrid;

import java.util.ArrayList;

/**
 * Created by Guasszjg on 2016/10/18 0018.
...
public class ChannelActivity extends AppCompatActivity  implements AdapterView.OnItemClickListener{
    ...
    private void initData()
    {
        ...
        Log.i(TAG, "initData: userChannelList " + userChannelList.size());
        Log.i(TAG, "initData: otherChannelList " + otherChannelList.size());
        userAdapter = new DragAdapter(this, userChannelList);
        userGridView.setAdapter(userAdapter);

        otherAdapter = new OtherAdapter(this, otherChannelList);
        int cout  = otherAdapter.getCount();
        Log.i(TAG, "initData: cout " + cout);
